...
st.markdown("""<h1 style="font-size: 2rem; font-family: Lora, sans-serif; margin-bottom: 1.5rem;">
...
<div style="font-size: 1.1rem; font-family: Lora, sans-serif; line-height: 1.7; margin-bottom: 2rem;">
