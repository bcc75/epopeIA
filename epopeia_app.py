...
st.markdown("""<h1 style="font-size: 2rem; font-family: goudy old style; margin-bottom: 1.5rem;">
...
<div style="font-size: 1.1rem; font-family: goudy old style; line-height: 1.7; margin-bottom: 2rem;">
