...
def redimensionar_imagem(imagem_path):
    ...
    imagem.thumbnail((300, 300))  # Redimensionar para thumbnail 300x300
...
if imagem_upload:
    ...
    st.image(imagem_path_redimensionada, caption="Imagem carregada", use_column_width=False, width=300)
