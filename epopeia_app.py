...
st.markdown("""<h1 style="font-size: 2rem; font-family: Felipa, sans-serif; margin-bottom: 1.5rem;">
...
<div style="font-size: 1.1rem; font-family: Helvetica, sans-serif; line-height: 1.7; margin-bottom: 2rem;">
  ...
  <p>⛵️ <strong>Epope<i>IA</i>:</strong> navega entre pixels e versos, com a alma lusitana sempre ao leme.</p>
